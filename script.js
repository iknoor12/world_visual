...
toggleDiv.innerHTML = `
    <div id="toggleButtons" style="text-align: center; margin-top: 2em;">
        <button id="populationBtn" style="padding: 0.5em 1em; margin: 0.5em; background-color: rgba(255, 99, 133, 0.84); border-radius: 5px;">POPULATION</button>
        <button id="languageBtn" style="padding: 0.5em 1em; margin: 0.5em; background-color: rgba(54, 163, 235, 0.85); border-radius: 5px;">LANGUAGES</button>
    </div>
        <h2 id="chartTitle" style="text-align: center;">Most Populated countries in the World</h2>
